...
gui.add(sphereMaterial, "iridescence", 0, 1).name("Iridescence");
gui.add(sphereMaterial, "reflectivity", 0, 1).name("Reflection");
gui.add(sphereMaterial, "iridescenceIOR", 0, 3).name("Iridescence IOR");
...
gui
  ...
  .name("Iridescence Thickness Min")
  .onChange(() => {
...
gui
  ...
  .name("Iridescence Thickness Max")
  .onChange(() => {
